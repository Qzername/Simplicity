...
public static class Geometries
{
    ...
    [DllImport(LibConsts.LibPath)]
    static extern IntPtr Geometries_wheel(uint segments, float radius);
    ...
    public static Geometry Wheel(uint segments, float radius) => new Geometry(Geometries_wheel(segments, radius));
